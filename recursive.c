...
unsigned clz_u8(uint8_t x, int c)
{
    ...
    return upper ? clz_u8(upper, c + 1) : (4 >> (c)) + clz_u8(lower, c + 1);
}
...
unsigned clz_u16(uint16_t x, int c)
{
    ...
    return upper ? clz_u16(upper, c + 1) : (8 >> (c)) + clz_u16(lower, c + 1);
}
...
unsigned clz_u32(uint32_t x, int c)
{
    ...
    return upper ? clz_u32(upper, c + 1) : (16 >> (c)) + clz_u32(lower, c + 1);
}
...
unsigned clz_u64(uint64_t x, int c)
{
    ...
    return upper ? clz_u64(upper, c + 1) : (32 >> (c)) + clz_u64(lower, c + 1);
}
